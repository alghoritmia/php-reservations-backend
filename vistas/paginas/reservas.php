    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
                    ...
                    <div class="row py-2" style="background:#509CC3">
                        ...
                        <div class="col-6 col-md-3 input-group pr-1">
                            ...
                            <input type="text" class="form-control datepicker entrada" autocomplete="off"
                                placeholder="Entrada" value="" required>

                            <div class="input-group-append">

                                <span class="input-group-text"><i
                                        class="far fa-calendar-alt small text-gray-dark"></i></span>
                        ...
                        <div class="col-12 col-md-6 mt-2 mt-lg-0 input-group">
                            ...
                            <button class="btn btn-block btn-md text-white verDisponibilidad" idHabitacion
                                style="background:black">Ver disponibilidad</button>
            ...
            <div class="modal-footer d-flex justify-content-between">
                ...
                <div>
                    <button type="button" class="btn btn-primary guardarNuevaReserva" fechaIngreso fechaSalida
                        idReserva>Guardar</button>
                </div>
