            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="rutaCategoria"
                            placeholder="Ingresa la ruta de la categoría" required>
                    ...
                    <div class="colorPicker input-group mb-3 colorpicker-component">
                        ...
                        <input type="text" placeholder="&#xf0a5; Elige color" class="form-control"
                            style="font-family:Source Sans Pro, Font Awesome\ 5 Free" name="colorCategoria" required>
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input type="text" class="form-control" name="tipoCategoria"
                            placeholder="Ingresa el tipo de categoría" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group my-2">
                            ...
                            <p class="help-block small">Dimensiones: 359px * 254px | Peso Max. 2MB | Formato: JPG o PNG
                            </p>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="continental_alta"
                            placeholder="Precio Plan Continental temporada alta" required>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="continental_baja"
                            placeholder="Precio Plan Continental temporada baja" required>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="americano_alta"
                            placeholder="Precio Plan americano temporada alta" required>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="americano_baja"
                            placeholder="Precio Plan americano temporada baja" required>
                ...
                <div class="modal-body">
                    ...
                    <div class="colorPicker input-group mb-3 colorpicker-component">
                        ...
                        <input type="text" class="form-control"
                            style="font-family:Source Sans Pro, Font Awesome\ 5 Free" name="editarColorCategoria"
                            required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="p-3" name="editarDescripcionCategoria" style="width: 100%"
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="editarCheckbox" type="checkbox" class="ml-3"
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="editar_continental_alta"
                            placeholder="Precio Plan Continental temporada alta" required>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="editar_continental_baja"
                            placeholder="Precio Plan Continental temporada baja" required>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="editar_americano_alta"
                            placeholder="Precio Plan americano temporada alta" required>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="editar_americano_baja"
                            placeholder="Precio Plan americano temporada baja" required>
