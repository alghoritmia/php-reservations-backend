                ...
                <div class="col-12">
                    ...
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-header">
                            ...
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#crearPlan">Crear
                                nuevo plan</button>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="tipoPlan" placeholder="Ingresa el nombre del plan"
                            required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group my-2">
                            ...
                            <p class="help-block small">Dimensiones: 480px * 382px | Peso Max. 2MB | Formato: JPG o PNG
                            </p>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="precio_alta"
                            placeholder="Precio temporada alta" required>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0" step="any" class="form-control" name="precio_baja"
                            placeholder="Precio temporada baja" required>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="editarDescripcionPlan" name="editarDescripcionPlan"
