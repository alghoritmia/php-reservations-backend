     ...
     <section class="content">
         ...
         <div class="card card-primary card-outline">
             ...
             <div class="card-header pl-2 pl-sm-3">
                 ...
                 <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#crearRecorrido">Crear nuevo
                     recorrido</button>
             ...
             <form method="post" enctype="multipart/form-data">
                 ...
                 <div class="modal-body">
                     ...
                     <div class="input-group mb-3">
                         ...
                         <input type="text" class="form-control" name="tituloRecorrido"
                             placeholder="Ingresa el título del Recorrido" required>

                     </div>

                     <div class="input-group mb-3">

                         <textarea class="form-control" maxlength="220" name="descripcionRecorrido"
                             placeholder="Ingresa la descripción del recorrido" required></textarea>
                     ...
                     <div class="form-group">
                         ...
                         <div class="form-group my-2">
                             ...
                             <p class="help-block small">Dimensiones: 455px x 280px | Peso Max. 2MB | Formato: JPG o PNG
                             </p>
                     ...
                     <div class="form-group">
                         ...
                         <div class="form-group my-2">
                             ...
                             <p class="help-block small">Dimensiones: 650px x 450px | Peso Max. 2MB | Formato: JPG o PNG
                             </p>
             ...
             <form method="post" enctype="multipart/form-data">
                 ...
                 <div class="modal-body">
                     ...
                     <div class="input-group mb-3">
                         ...
                         <textarea class="form-control" maxlength="220" name="editarDescripcionRecorrido"
                             required></textarea>
