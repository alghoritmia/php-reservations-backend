                ...
                <div class="col-12 col-xl-7">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-header">
                            ...
                            <h5 class="card-title"><?php echo $habitacion["tipo"] ?> /
                                <?php echo $habitacion["estilo"] ?></h5>
                  ...
                  ?>
                   ...
                   ?>
                                ...
                                <input type="hidden" class="inputAntiguaGaleria"
                                    value="<?php echo implode(",", $galeria); ?>">
                                    ...
                                    <div class="card rounded-lg card-secondary card-outline">
                                        ...
                                        <div class="card-body vistaVideo">
                                            ...
                                            <iframe width="100%" height="320"
                                                src="https://www.youtube.com/embed/<?php echo $habitacion["video"]; ?>"
                                                frameborder="0"
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    <span
                                                        class="p-2 bg-secondary rounded-left small">youtube.com/embed/</span>
                                                </div>

                                                <?php if ($habitacion != null): ?>

                                                <input type="text" class="form-control agregarVideo"
                                                    placeholder="Agregue el código del vídeo"
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <div class="card rounded-lg card-secondary card-outline">
                                        ...
                                        <div class="card-body ver360">
                                            ...
                                            <div class="pano 360Antiguo"
                                                back="<?php echo $habitacion["recorrido_virtual"]; ?>">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <input type="hidden" class="antiguoRecorrido"
                                                value="<?php echo $habitacion["recorrido_virtual"]; ?>">
